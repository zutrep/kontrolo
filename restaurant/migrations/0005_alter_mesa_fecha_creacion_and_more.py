...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('restaurant', '0004_alter_mesa_fecha_creacion_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='fecha_atencion',
            field=models.DateField(default=datetime.datetime(2024, 9, 7, 17, 4, 29, 913925, tzinfo=datetime.timezone.utc)),
        ),
        migrations.AlterField(
            model_name='plato',
            name='fecha_creacion',
