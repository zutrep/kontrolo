...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ventas', '0015_alter_boletadetalle_fecha_creacion_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='fecha_creacion',
            field=models.DateTimeField(default=datetime.datetime(2024, 9, 8, 21, 46, 6, 299982, tzinfo=datetime.timezone.utc)),
        ),
        migrations.AlterField(
