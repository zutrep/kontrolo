...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('compras', '0013_alter_boletacompradetalle_fecha_creacion_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='fecha_creacion',
            field=models.DateTimeField(default=datetime.datetime(2024, 9, 9, 2, 30, 54, 975326, tzinfo=datetime.timezone.utc)),
        ),
        migrations.AlterField(
